...
and fairly. Maintainers are obligated to respect the privacy and security
of the reporter.
...
1. **Correction** — private written warning, with clarity around the
   nature of the violation and why it was inappropriate.
2. **Warning** — public or private warning with consequences for continued
   behavior.
