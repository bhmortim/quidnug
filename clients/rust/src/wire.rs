...
/// Per-owner stake on a TITLE transaction (wire form).
#[derive(Debug, Clone, Serialize)]
pub struct TitleOwnerWire<'a> {
...
pub struct TitleTx<'a> {
    ...
    pub asset_id: &'a str,
    pub owners: Vec<TitleOwnerWire<'a>>,
    #[serde(rename = "previousOwners", skip_serializing_if = "Vec::is_empty")]
    pub previous_owners: Vec<TitleOwnerWire<'a>>,
