...
/// Mirror of `core.OwnershipStake` for signed-wire output.
#[derive(Debug, Serialize)]
...
// ---------------------------------------------------------------
// NODE_ADVERTISEMENT (QDP-0014)
// ---------------------------------------------------------------

/// Mirror of `core.NodeAdvertisementTransaction`. Used as a
/// signing helper — the SDK callers use the higher-level
/// `Client::publish_node_advertisement`.
#[derive(Debug, Serialize)]
pub struct NodeAdvertisementTx<'a> {
    pub id: String,
    #[serde(rename = "type")]
    pub tx_type: &'a str,
    #[serde(rename = "trustDomain")]
    ...
    #[serde(rename = "nodeQuid")]
    pub node_quid: &'a str,
    #[serde(rename = "operatorQuid")]
    pub operator_quid: &'a str,
    pub endpoints: &'a [crate::types::NodeAdvertEndpoint],
    #[serde(rename = "supportedDomains", skip_serializing_if = "<[String]>::is_empty")]
    pub supported_domains: &'a [String],
    pub capabilities: &'a crate::types::NodeAdvertCapabilities,
    #[serde(rename = "protocolVersion")]
    pub protocol_version: &'a str,
    #[serde(rename = "expiresAt")]
    pub expires_at: i64,
    #[serde(rename = "advertisementNonce")]
