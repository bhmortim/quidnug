...
| Domains | `list_domains`, `register_domain`, `ensure_domain`, `top_domains`, `query_domain`, `get_node_domains`, `update_node_domains` |
| Gossip / advertisements | `send_domain_gossip`, `create_node_advertisement` |
